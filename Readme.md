...
- **notebook.ipynb** – Jupyter notebook (code)  
...
Model Used
YOLOv8 Pose from Ultralytics (GitHub Link)
...
nkeypoint.csv – keypoints stored in CSV format:
...
Copy code
jupyter notebook
Open the provided notebook (e.g., pose_detect.ipynb).
...
Notes
You can change the confidence threshold (default: 0.5) to control detection sensitivity.
...
Visualizing skeletons on saved frames
